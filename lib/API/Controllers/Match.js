...
module.exports = function(server) {
  ...
  server.post('/v1/matchmaker',
    ...
    function (req, res, next) {
      ...
      // TODO use isCharacterNeeded and isPlayerNeeded for post data validation
      // TODO check that all attributes that does not have a default value is provided
